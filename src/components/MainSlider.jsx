                            ...
                            <div className="w-full h-[70vh] sm:h-[80vh] md:h-[90vh] lg:h-screen relative">
                                ...
                                >
                                    ...
                                    <div data-aos="zoom-in" data-aos-delay="400">
                                        <Button
                                            variant="default"
                                            className="bg-orange-500 hover:bg-transparent hover:border-orange-500 rounded-full text-sm sm:text-base font-bold px-8 sm:px-12 h-[45px] sm:h-[55px] hover:text-orange-500 hover:shadow-lg hover:border-[2px] sm:block hidden"
                                        >
                                            {slide.button}
                                        </Button>
                                    </div>
