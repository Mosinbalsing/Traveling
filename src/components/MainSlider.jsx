...
const slides = [
    {
        ...
        title: "Best Worldwide <br /><span class='text-orange-500'>Car Hire</span> Deals",
    ...
    return (
        <section className="relative mt-[-50px] max-w-[1600px] mx-auto">
            <Carousel className="w-full overflow-hidden relative">
                ...
                >
                    {slides.map((slide) => (
                        <CarouselItem key={slide.id} className="relative w-full flex-shrink-0">
                            <div className="w-full h-[70vh] sm:h-[80vh] md:h-[90vh] lg:h-screen relative">
                                ...
                                <div
                                    ...
                                    ${slide.center ? "items-center text-center" : "items-start md:pl-24 lg:pl-48"}`}
                                >
                                    <h2
                                        className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl uppercase mb-4 w-full sm:w-[80%] md:w-[70%] font-black"
                                        dangerouslySetInnerHTML={{ __html: slide.title }}
                                        data-aos="fade-up"
                                    ></h2>
                                    <p
                                        className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl mb-6 w-full sm:w-[80%] md:w-[70%]"
                                        data-aos="fade-up"
                                        data-aos-delay="200"
                                    ...
                                    <div data-aos="zoom-in" data-aos-delay="400">
                                        <Button
                                            variant="default"
                                            className="bg-orange-500 hover:bg-transparent hover:border-orange-500 rounded-full text-sm sm:text-base font-bold px-8 sm:px-12 h-[45px] sm:h-[55px] hover:text-orange-500 hover:shadow-lg hover:border-[2px]"
                                        >
                                            {slide.button}
                                        </Button>
                                    </div>
